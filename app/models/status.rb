...
class Status < ApplicationRecord
  ...
  cache_associated :application, :media_attachments, :conversation, :tags, :stream_entry, mentions: { account: :oauth_authentications }, reblog: [{ account: :oauth_authentications }, :application, :stream_entry, :tags, :media_attachments, :conversation, mentions: { account: :oauth_authentications }], thread: { account: :oauth_authentications }, account: :oauth_authentications
